            ...
            <div class="widget-content nopadding">
              ...
              <form class="form-horizontal" method="post" action="{{url('/admin/add-currency')}}" name="add_currency" id="add_currency" novalidate="novalidate">
                    ...
                    <div class="control-group">
                            ...
                            <div class="controls">
                            <input type="text" value="{{ old('country_name') }}" name="country_name" id="country_name">
                            </div>
                     </div>        
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" value="{{ old('currency_code') }}" name="currency_code" id="currency_code">
                    </div>
                  </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" value="{{ old('exchange_rate') }}" name="exchange_rate" id="exchange_rate">
                    </div>
                </div>                 
