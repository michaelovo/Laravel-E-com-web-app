              ...
              <tbody>
                @foreach($currencies as $currency)
                  <tr class="gradeX">
                    ...
                    <td class="center">
                      <div class="fl">
                        <a href="{{url('/admin/edit-currency/'.$currency->id)}}" class=" icon icon-edit btn btn-primary" title="Edit Currency"></a> 
                        <a id ="delCat" href="{{url('/admin/delete-currency/'.$currency->id)}}" class=" icon icon-trash btn btn-danger" title="Delete Currency"></a>
                    </div>
