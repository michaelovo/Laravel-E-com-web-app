...
<link rel="stylesheet" href="{{asset('css/backend_css/bootstrap.min.css')}}" rel="stylesheet"/>
<link rel="stylesheet" href="{{asset('css/backend_css/bootstrap-responsive.min.css')}}" /rel="stylesheet">
<link rel="stylesheet" href="{{asset('css/backend_css/fullcalendar.css')}}" rel="stylesheet"/>
<link rel="stylesheet" href="{{asset('css/backend_css/matrix-style.css')}}"rel="stylesheet" />
<link rel="stylesheet" href="{{asset('css/backend_css/matrix-media.css')}}"rel="stylesheet" />
<link href="{{asset('font/backend_font/font-awesome/css/font-awesome.css')}}" rel="stylesheet" />
<link rel="stylesheet" href="{{asset('css/backend_css/jquery.gritter.css')}}" rel="stylesheet"/>
